...
function pack(packageName) {
  ...
  return getModulePath(packageName, cwd).then(function (filePath) {
    ...
    try {
      ...
      var gypStdio = _child_process2.default.spawnSync(_path2.default.resolve('node_modules', '.bin', 'node-gyp'), ['--debug', '--release', '--msvs_version=2015'], { cwd: zipFrom, encoding: 'utf-8' });
